...
public class FibonacciDemo {
	public static void main(String[] args) 
		...
		System.out.println("Synchronous Long Running Calculation");
		...
		// perform asynchronous fibonacci(45) and fibonacci(44) calculatinos
		...
		// wait for results from the asynchronous operation
	...
	// display fibonacci calcualtion result and total calculation time
	private static void displayResult(int n, long value, TimeData timeData) {
		System.out.printf("  fibonacci(%d) = %d%n", n, value);
		System.out.printf(
				"  Calculation time for fibonacci(%d) = %.3f seconds%n", n, 
				timeData.timeInSeconds());
	}
